...
int main(int argc, char** argv) {
  ...
  const std::vector<std::string> names{
      "computeLocalIntegration.nc", "computeNeighboringIntegration.nc", "computeDynamicRupture.nc"};
  ...
  auto cmp_begin = [](const auto& a, const auto& b) { return a.begin < b.begin; };
  auto cmp_end = [](const auto& a, const auto& b) { return a.end < b.end; };
  auto cmp_subRegion = [](const auto& a, const auto& b) { return a.subRegion < b.subRegion; };
